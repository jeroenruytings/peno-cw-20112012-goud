...
public interface Config {
	...
	public static final String HOST_NAME = "localhost";//"leuven.cs.kotnet.kuleuven.be";//"leuven.cs.kotnet.kuleuven.be";
	public static final int PORT = 5672;
	
	// the default exchange that will be used for races during the official demo's
	//RaceExchange
	public static final String EXCHANGE_NAME = "teamgold";

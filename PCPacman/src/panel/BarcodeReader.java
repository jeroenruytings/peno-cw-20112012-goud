...
public class BarcodeReader implements Runnable{
	...
	enum barcode {
		 one(0, 0, 0, 0, 0, 0, 1), two(0, 0, 0, 0, 0, 1, 0), three(0, 0, 0, 0, 0, 1, 1), 
		 four(0, 0, 0, 0, 1, 0, 0), five(0, 0, 0, 0, 1, 0, 1), six(0, 0, 0, 0, 1, 1, 0), 
		 seven(0, 0, 0,0, 1, 1, 1), eight(0, 0, 0, 1, 0, 0, 0), nine(0, 0, 0, 1, 0, 0,1), 
		 ten(0, 0, 0, 1, 0, 1, 0), eleven(0, 0, 0, 1, 0, 1, 1), c(1, 1, 0,0, 1, 1, 0), 
		 d(1, 1, 0, 1, 0, 0, 1), e(1, 1, 1, 0, 0, 0, 0), f(1, 1, 1, 1, 1, 1, 1);
